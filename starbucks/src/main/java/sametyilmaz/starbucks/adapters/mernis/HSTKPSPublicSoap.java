...
public class HSTKPSPublicSoap
{
    ...
    public HSTKPSPublicSoap(){}

    public HSTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HSTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HSTExtendedSoapSerializationEnvelope envelope= new HSTExtendedSoapSerializationEnvelope(HSTExtendedSoapSerializationEnvelope.VER11);
