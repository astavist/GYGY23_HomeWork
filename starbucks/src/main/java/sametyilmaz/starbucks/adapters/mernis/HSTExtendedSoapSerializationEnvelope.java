...
class HSTSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class HSTExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HSTDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HSTStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HSTDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HSTDateTimeConverter dateTimeConverter = new HSTStandardDateTimeConverter();

    public HSTExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HSTExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HSTMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HSTHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HSTExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HSTHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
